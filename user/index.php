...
<?php
	...
	if(isset($_SESSION['user_id']) && !empty($_SESSION['user_id']) ){
		...
		<div class="alert alert-danger alert-dismissible fade show" role="alert">
									<strong>Have you donated blood ?</strong>
				...
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
							...
							<p class="text-center">After donating blood you should press below.</p>
							...
							<?php
									...
									if($saveDate == '0'){
										...
										echo '<form target="" method="post">
											<button style="margin-top: 20px;" name="date" id="save_the_life" class="btn btn-lg btn-danger center-aligned ">Donate blood</button>
										</form>';
